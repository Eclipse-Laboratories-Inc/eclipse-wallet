...
public class SignTransactionsRequestMapper implements ScenarioRequestMapper<SignTransactionsRequest> {
    @Override
    public ReadableMap toReadableMap(SignTransactionsRequest request) {
