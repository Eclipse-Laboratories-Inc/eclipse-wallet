...
const routes = [
  ...
  // },
  {
    ...
    name: 'nftsBuying',
    path: 'hyperspace/:id/:nftId/:pageNumber/buy',
    route: '/wallet/nfts/hyperspace/:id/:nftId/:pageNumber/buy',
  ...
  },
  {
    ...
    name: 'nftsBidding',
    path: 'hyperspace/:id/:nftId/:pageNumber/offer/:type',
    route: '/wallet/nfts/hyperspace/:id/:nftId/:pageNumber/offer/:type',
