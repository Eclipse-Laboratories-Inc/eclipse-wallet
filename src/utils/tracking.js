export const SECTIONS_MAP = {
  ...
  NFTS_BUY_DETAIL: 'nft-buy-detail',
  NFT_BID: 'nft-bid',
  NFT_BUY: 'nft-buy',
  NFT_SEND: 'nft-send',
  SWAP: 'swap',
...
export const EVENTS_MAP = {
  ...
  NFT_BUY_COMPLETED: 'nft-buy-completed',
  NFT_BUY_FAILED: 'nft-buy-failed',
  NFT_BID_COMPLETED: 'nft-bid-completed',
  NFT_BID_FAILED: 'nft-bid-failed',
